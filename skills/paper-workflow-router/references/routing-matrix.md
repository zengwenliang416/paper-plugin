...
| draft, rewrite, opening report, literature review prose, de-AI, polish, quality gate, thesis folder intake | `paper-manuscript-writing` | `skills/paper-manuscript-writing/SKILL.md` |
| DOCX, Word, WPS, page numbers, TOC, three-line tables, formula layout, OOXML, rendered format | `paper-docx-repair` | `skills/paper-docx-repair/SKILL.md` |
...
2. `paper-manuscript-writing`: inspect project materials, source of truth, evidence gaps, and claim ledger.
...
5. `paper-docx-repair`: repair or validate the final DOCX after content/evidence changes.
